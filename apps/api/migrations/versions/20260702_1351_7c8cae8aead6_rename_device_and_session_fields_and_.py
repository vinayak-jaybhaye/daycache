...
def upgrade() -> None:
    ...
    op.drop_constraint('devices_user_id_device_identifier_key', 'devices', type_='unique')
    op.create_unique_constraint('devices_user_id_installation_id_key', 'devices', ['user_id', 'installation_id'])
...
def downgrade() -> None:
    ...
    op.create_unique_constraint('devices_user_id_device_identifier_key', 'devices', ['user_id', 'device_identifier'])
